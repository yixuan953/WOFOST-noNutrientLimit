...
void SoilNutrientRates()
{
    ...
    Site->rt_N_tot = (N_fert / Step) - Crop->N_rt.Uptake  + Site->rt_N_mins + N_total_dep[Lon][Lat][Day];
    Site->rt_P_tot = (P_fert / Step) - Crop->P_rt.Uptake  + Site->rt_P_mins + P_total_dep[Lon][Lat][Day];
